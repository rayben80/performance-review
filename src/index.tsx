...
app.get('/dashboard', (c) => {
  return c.html(`
    ...
    <body class="bg-gray-50 text-gray-800">
        ...
        // 빠른 추가 기능들 - quickAddModal.js로 이동됨
        // quickAddQuantitativeItem, quickAddQualitativeItem 함수는
        // /js/quickAddModal.js 파일에서 관리됩니다.
            ...
            // 모달 표시 with 애니메이션
            console.log('모달 표시 시작', modal);
            modal.classList.remove('hidden');
            modal.classList.add('flex');
            console.log('모달 클래스:', modal.className);
            // 애니메이션 트리거
            setTimeout(() => {
                const slideUp = modal.querySelector('.animate-slideUp');
                if (slideUp) {
                    slideUp.style.transform = 'translateY(0) scale(1)';
                }
            }, 10);
